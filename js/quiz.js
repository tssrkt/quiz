(function (root, factory) {
  ...
  function resultMessage(percent) {
    ...
    return 'Попробуйте пройти викторину ещё раз.';
  }
...
function init(core) {
  ...
  function renderResult() {
    ...
    app.querySelector('[data-low-result-restart]')?.addEventListener('click', (event) => { event.preventDefault(); restart(); });
    app.querySelector('[data-restart]').addEventListener('click', restart);
